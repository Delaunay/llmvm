#!/usr/bin/env python
"""
llmvm documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "llmvm"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import llmvm.core  # noqa
...
project = "llmvm"
_full_version = llmvm.core.__version__
author = llmvm.core.__author__
copyright = llmvm.core.__copyright__
